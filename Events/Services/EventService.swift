...
//  Events
//
//  Created by Alex Stupalov on 11/8/21.
//
...
final class EventService: EventServiceProtocol {
    ...
    func perform(_ action: EventAction, data: EventInputData) {
        ...
        let resezedImage = data.image.sameAspectRatio(newHeight: 250)
        let imageData = resezedImage.jpegData(compressionQuality: 0.5)
